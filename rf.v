    ...
    generate
        ...
        if(BYPASS_EN == 1) begin
            ...
            assign o_rs1_rdata = (i_rs1_raddr == 5'b0) ? 32'b0 : 
                ((i_rs1_raddr == i_rd_waddr) & (i_rd_wen == 1)) ? i_rd_wdata : mem[i_rs1_raddr];

            assign o_rs2_rdata = (i_rs2_raddr == 5'b0) ? 32'b0 :  
                ((i_rs2_raddr == i_rd_waddr) & (i_rd_wen == 1)) ? i_rd_wdata : mem[i_rs2_raddr];
        end
        else begin
            //read address output data
            assign o_rs1_rdata = (i_rs1_raddr == 5'b0) ? 32'b0 : mem[i_rs1_raddr];
            assign o_rs2_rdata = (i_rs2_raddr == 5'b0) ? 32'b0 : mem[i_rs2_raddr];
        end
    endgenerate
